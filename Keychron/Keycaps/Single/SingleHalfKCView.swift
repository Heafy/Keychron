...
struct SingleHalfKCView: Keycap {
    
    var text: String
    var colorSet: ColorSet
    var width: CGFloat = Constants.Size.singleHalf
...
struct SingleHalfKCView_Previews: PreviewProvider {
    static var previews: some View {
        HStack(spacing: 2) {
            SingleHalfKCView(text: "tab", colorSet: .orangeKC)
        }
